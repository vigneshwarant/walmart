...
*/		
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tileView.addDetailLevel(1f, "qabay/tiles/1000_%col%_%row%.png", "qabay/downsamples/map.png");
        tileView.addDetailLevel(0.5f, "qabay/tiles/500_%col%_%row%.png", "qabay/downsamples/map.png");
        tileView.addDetailLevel(0.25f, "qabay/tiles/250_%col%_%row%.png", "qabay/downsamples/map.png");
        tileView.addDetailLevel(0.125f, "qabay/tiles/125_%col%_%row%.png", "qabay/downsamples/map.png");
		}
        ...
        tileView.slideToAndCenter( STARTPOSITION.getX(), STARTPOSITION.getY() );
    ...
    private HashMap<Integer, BeaconCustom> instantiateBeacons() {
		...
		item = new Item("Apple Fruit", "10", "","Reviews", 5);
		item.setSectionId(2);
		itemsMap.put(item.getItemName(), item);
		foodBeaconItems.put("Apple Fruit", item);
		...
		beacon.setPromotion("Wilson racket 25% Off");
		...
		item = new Item("The Man Who Knew Infinity", "55", "5 books for $10 each","Reviews", 5);
		item.setSectionId(4);
		itemsMap.put(item.getItemName(), item);
		booksBeaconItems.put("The Man Who Knew Infinity", item);
		...
		item = new Item("Water Bottle", "5", "","Reviews", 5);
		item.setSectionId(5);
		itemsMap.put(item.getItemName(), item);
		stationeryBeaconItems.put("Water Bottle", item);
		...
		beacon.setPromotion("Buy Clarke leather shoe pair for 50$");
	...
	/*	private ArrayList<BeaconCustom> sortProductList( ArrayList<BeaconCustom> beaconCustomsList) {
		...
		*/
		...
		/**
		 * To get Demo Video products
		 * @param products
		 */
		private void addDemoVideo(ArrayList<String> products) {
		products.add("Apple Fruit");
		products.add("IPhone 6s");
		products.add("The Man Who Knew Infinity");
		}
		/**
		 * 
		 * @param products
