	 ...
	 */
	 ...
	 public static ArrayList<ProductListViewBean> getMyWishList(){
		 ...
		 ProductListViewBean item1 = new ProductListViewBean();
		   ...
		   item1.setBrandName("Washington");
		   item1.setImageName(R.drawable.apple);
		   item1.setPrice("$10");
		   item1.setProductName("Apple Fruit");
		   item1.setProductShortDesc("Special Organic Apple");
		   ...
		   item3.setAvailableQty("30 books");
		   item3.setBrandName("Abacus");
		   item3.setImageName(R.drawable.ramanujan_biography);
		   item3.setPrice("$55");
		   item3.setProductName("The Man Who Knew Infinity");
		   item3.setProductShortDesc("");
